...
subj_ts<-read.table('....UCI HAR Dataset/test/subject_test.txt')
...
#Write out file
write.table(HAR_df, "....UCI HAR Dataset/TIDY_SET.txt", sep="\t")
write.table(HAR_df2, "....UCI HAR Dataset/GROUPED_SET.txt", sep="\t")